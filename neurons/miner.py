...
class Miner(BaseMinerNeuron):
    ...
    def __init__(self, config=None):
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            implementation_files=[
                repo_root / "weights" / "gen13_tens15_170_10_ft7_hardened.ts",
            ...
            defaults={
                "model_name": "poker44_ml13tens15",
                "model_version": "13.15",
                "framework": "pytorch-torchscript",
                "license": "MIT",
                "repo_url": "https://github.com/tomkaba/poker44-miner-ml13tens15",
                "repo_commit": git_commit,
                "notes": "Gen13Tens15 neural network scorer (POT=170, AAF=10)",
                "open_source": True,
    ...
    async def forward(self, synapse: DetectionSynapse) -> DetectionSynapse:
        ...
        bt.logging.info(f"Scored {len(chunks)} chunks with scorer ml13tens15.")
        return synapse
...
if __name__ == "__main__":
    ...
    with Miner() as miner:
        ...
        while True:
            bt.logging.info(
                f"Miner UID: {miner.uid} | Incentive: {float(miner.metagraph.I[miner.uid])} | Scorer: ml13tens15"
            )
            time.sleep(60)
